...
class Vite
{
    ...
    private $viteHostProtocol = 'http://';
    private $viteHost = 'localhost';
    private $vitePort = '8880';
    private $resourceDirectory = 'src/';
     ...
     * 
     */
    private function enqueueScript($handle, $src, $dependency = [], $version = nul)
    {
